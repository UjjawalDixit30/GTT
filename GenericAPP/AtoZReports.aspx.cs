...
{
    public partial class AtoZReports : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var httpWebRequest = (HttpWebRequest)WebRequest.Create(cGeneral.BaseURL + "GetATOZReports?LoginID=" + LoginID + "&FromDate=" + fromDate + "&ToDate=" + toDate);
                ...
                if (Convert.ToString(httpResponse.StatusCode) == "OK")
                {
                    ...
                    if (ds != null)
                    {
                        ...
                        {
                            rptActivationReport.DataSource = ds.Tables[0];
        ...
        {
            Response.Redirect("AtoZReports.aspx", false);
        }
