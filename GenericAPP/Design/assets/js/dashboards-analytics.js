...
(function () {
    ...
    // --------------------------------------------------------------------
    const chartOrderStatistics = document.querySelector('#ActivationChart'),
        orderChartConfig = {
            chart: {
                height: 165,
                width: 130,
    ...
    // Order Statistics Chart
    // --------------------------------------------------------------------
    const chartOrderStatistics1 = document.querySelector('#RechargeChart'),
        orderChartConfig1 = {
            chart: {
                height: 165,
                width: 130,
    ...
    // Order Statistics Chart
    // --------------------------------------------------------------------
    const chartOrderStatistics2 = document.querySelector('#revenewChart'),
        orderChartConfig2 = {
            chart: {
                height: 165,
                width: 130,
