<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Forgot.aspx.cs" Inherits="GenericAPP.Forgot" %>
            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formForgotPassword" class="mb-3" action="ResetPassword.aspx" method="POST">
                            <div class="mb-3">
                                <input type="email" class="form-control" id="email" name="email" placeholder="Please enter your username" required autofocus />
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit">Recover Password</button>
                            </div>
